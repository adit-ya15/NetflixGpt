  ...
  return (
    ...
    >
      ...
      <div className="relative rounded-md overflow-hidden">
        ...
        >
          {/* play */}
          <button className="bg-white rounded-full p-1 transition-transform duration-300 hover:scale-110">
          ...
          {/* add */}
          <button className="border border-white rounded-full p-1 transition-transform duration-300 hover:scale-110">
